...
class DistanceFromGroundChecking:
    def __init__(self, angles: list):
        ...
        self.wirstLength = 0.07# length of the wirst to add on z axis
    ...
    def checkDistanceFromTheGround(self):
        ...
        for joint_index in range(1, 7):  # Assuming there are 6 joints
            ...
            result[joint_index] = coord["z"] - self.safeDistancesFromTheGround >= 0.0 # TODO: Define the ground level to 0 
        return result
